...
const SignUp = () => {
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="State Bnak Of India">State Bnak Of India</option>
  ...
  <div className="flex-1">
    <label className="text-[16px] text-stone-600 font-semibold">IFSC Code</label>
    <input
      type="text"
      value={ifscCode}
  ...
  <div className="flex-1">
    <label className="text-[16px] text-stone-600 font-semibold">UPI Id</label>
    <input
      type="text"
      value={upiId}
      placeholder="UPI Id"
